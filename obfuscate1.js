// api/obfuscate.js
// Vercel Serverless Function for Luau Obfuscation
    ...
    obfuscate(code) {
        ...
        return {
            ...
            stats: {
                ...
                sizeIncrease: Math.round(((obfuscated.length / code.length) - 1) * 100),
